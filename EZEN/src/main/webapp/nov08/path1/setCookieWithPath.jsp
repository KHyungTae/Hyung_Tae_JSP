...
<%
	Cookie cookie1 = new Cookie("path1", URLEncoder.encode("경로:/EZEN/nov08/path1", "euc-kr"));
	...
	Cookie cookie4 = new Cookie("path4", URLEncoder.encode("경로:/EZEN/nov08/path2", "euc-kr"));
